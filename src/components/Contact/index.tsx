            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-blue bg-gray-1 border-gray-3 focus:ring-blue"
                      />
                ...
                <button
                  ...
                  className="inline-flex font-medium text-dark bg-green-brand py-3 px-7 rounded-md ease-out duration-200 hover:bg-opacity-90 shadow-1 hover:shadow-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
