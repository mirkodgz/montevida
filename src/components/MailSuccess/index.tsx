...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"Correo Enviado"} pages={["Correo Enviado"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Muchas gracias por tu mensaje. Verificamos el correo frecuentemente
                y trataremos de responder lo antes posible.
              </p>
