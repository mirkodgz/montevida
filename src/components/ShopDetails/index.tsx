...
const ShopDetails = ({ currentProduct }: { currentProduct?: Product }) => {
  ...
  const product = currentProduct || (alreadyExist ? JSON.parse(alreadyExist) : productFromStorage);
                      ...
                      <>
                        ...
                        <div className="mb-6 text-dark max-w-none flex flex-col gap-4">
                          {Array.isArray(product.presentation) ? (
                            <PortableText value={product.presentation as any} />
                          ) : (
                            <p>{product.presentation as React.ReactNode}</p>
                          )}
                        </div>
                      </>
                    )}
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="rounded-xl bg-white shadow-1 p-4 sm:p-6">
                        ...
                        <p className="text-dark mt-6">
                          “Me encantaron, el envío llegó súper rápido a Surco y la presentación es impecable. Empecé a probarlas hace una semana y se sienten de muy buena calidad. Súper recomendadas para el día a día.”
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl bg-white shadow-1 p-4 sm:p-6">
                        ...
                        <p className="text-dark mt-6">
                          “Tienen muy buen sabor, nada empalagosas. Pedí el pack grande para compartir y nos ha gustado a todos en casa. ¡Qué bueno encontrar marcas peruanas así de buenas!”
                        </p>
                      </div>
                      ...
                      <div className="rounded-xl bg-white shadow-1 p-4 sm:p-6">
                        ...
                        <p className="text-dark mt-6">
                          “10/10 calidad/precio. Hice mi compra un jueves y el viernes ya lo tenía en mi domicilio. Todo excelente con la asesoría por WhatsApp. Ya soy caserita.”
                        </p>
                      </div>
                    </div>
                  </div>
